...
@include('pages.admin-orders-pages.tabs.tabs')
        
<livewire:admin.order.order-requests/>
        
@livewireScripts
<script>
    window.addEventListener('show-approved-message', event =>{
        Swal.fire({
        title: "Order Approved",
        text: "You can now process the order.", 
        icon: 'success',
        timer: 5000,
