                                ...
                                <thead>
                                  <tr>
                                    ...
                                    <th class="text-dark w-10">
                                        <button class="btn btn-info btn-sm mt-3 me-1 text-white tbl-row-icon" style="cursor: pointer ">Approve All<i class="fa-solid fa-check ms-2" title="View product details" style="font-size: 14px;"></i></button>
                                    </th>
                                  </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <div class="d-flex" style="min-width: 20; max-width: 20; white-space:normal; min-height:80px; max-height: 80px; overflow:scroll; align-items: center;">
                                                <ul class="list-group w-100">
                                                    <li class="list-group-item">
                                                        <p class="text-xs text-dark mb-0">2x<span class="mx-2">|</span>Chocolate</p>
                                                    </li>
