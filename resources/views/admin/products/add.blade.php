                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mt-3">
                                                                ...
                                                                <div class="form-outline">
                                                                <input type="Meta title" id="" class="form-control  p-2" placeholder="Slug" style="box-shadow: 0 2px 5px rgba(182, 182, 182, 0.75); font-size: 14px;" name="meta_title" value="{{old('slug')}}"/>
                                                                </div>
                                                                @error('meta_title')
                                                                    <p class="text-danger">
                                                                        <small>{{$message}}</small>
